...
const YuCard = forwardRef(({ inputValues, templateImage, cardImage }, ref) => {
  return (
    <div
      ref={ref}
      className="w-[750px] h-[1090.5px] aspect-[5/7.27] relative bg-cover bg-center"
      style={{
        backgroundImage: `url(${templateImage || "./yugioh/normal_front.png"})`,
      }}
    >
      <div
      ...
      {cardImage && (
        <div style={{backgroundImage: `url(${cardImage})`}} className="object-fit bg-center bg-cover select-none absolute rounded-[2px] top-[199px] left-[85px] w-[580px] h-[570px] object-cover0"></div>
      )}
      ...
      <div style={{backgroundImage: `url("./yugioh/seal.png)`}} className="object-fit bg-center bg-cover select-none absolute rounded-[2px] bottom-[50px] right-[50px] w-[24px] h-[24px] object-cover"></div>
